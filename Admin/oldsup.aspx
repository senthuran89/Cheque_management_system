<%@ Page Language="C#" MasterPageFile="~/Admin/Adminmain.master" AutoEventWireup="true" CodeFile="oldsup.aspx.cs" Inherits="Admin_oldsup" Title="Untitled Page" %>
        ...
        <tr>
            <td class="style17" valign="top">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:CMSConnectionString147 %>" 
                    SelectCommand="SELECT [Sid], [Firstname], [Lastname], [Address], [NICno], [Companyname], [Companyaddress], [Companyphone1], [Personalphone], [Joindate] FROM [Supplier]">
                </asp:SqlDataSource>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="style19" bgcolor="#999999" valign="top">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="Button4" runat="server" Text="Find" 
                    Width="71px" onclick="Button4_Click1" />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </td>
        </tr>
        <tr>
            <td class="style18" bgcolor="Silver">
                ...
                <asp:SqlDataSource ID="SqlDataSource6" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:CMSConnectionString159 %>" 
                    SelectCommand="SELECT [Firstname] FROM [Supplier]"></asp:SqlDataSource>
                <asp:SqlDataSource ID="SqlDataSource7" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:CMSConnectionString160 %>" 
        ...
        <tr>
            <td class="style18">
                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
                    ...
                    ForeColor="#333333" GridLines="None" 
                    onselectedindexchanged="GridView2_SelectedIndexChanged2">
                    <RowStyle BackColor="#EFF3FB" />
                    <Columns>
                        <asp:BoundField DataField="Sid" HeaderText="Sid" InsertVisible="False" 
                            ReadOnly="True" SortExpression="Sid" />
                ...
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:CMSConnectionString150 %>" 
        ...
        <tr>
            <td class="style18">
                ...
                <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:CMSConnectionString152 %>" 
                    SelectCommand="SELECT [Sid], [Firstname], [Lastname], [City], [Companyname], [Companyphone1], [Personalphone], [Regno], [Joindate] FROM [Supplier] WHERE ([Companyname] = @Companyname)">
                    <SelectParameters>
        ...
        <tr>
            <td class="style18">
                <asp:SqlDataSource ID="SqlDataSource4" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:CMSConnectionString154 %>" 
                    SelectCommand="SELECT [Sid], [Firstname], [Lastname], [City], [Companyname], [Companyaddress], [Companyphone1], [Regno], [Joindate], [NICno] FROM [Supplier] WHERE ([NICno] = @NICno)">
                    <SelectParameters>
        ...
        <tr>
            <td class="style18">
                <asp:SqlDataSource ID="SqlDataSource5" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:CMSConnectionString156 %>" 
