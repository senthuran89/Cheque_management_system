<%@ Page Language="C#" MasterPageFile="~/Accountent/Accountentmain.master" AutoEventWireup="true" CodeFile="SupChequeview.aspx.cs" Inherits="Accountent_SupChequeview" Title="Untitled Page" %>
            ...
            <tr>
                <td bgcolor="#99CCFF">
                    <asp:Label ID="Label30" runat="server" 
                        Text="Suppliers  Cheque Details"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
