<%@ Page Language="C#" MasterPageFile="~/Accountent/Accountentmain.master" AutoEventWireup="true" CodeFile="updatesupdetails.aspx.cs" Inherits="Accountent_updatesupdetails" Title="Untitled Page" %>
    ...
    <table style="width:97%; height: 809px;" bgcolor="#EFEFEF" frame="box">
        ...
        <tr>
            <td class="style63" valign="top">
                <asp:Label ID="Label31" runat="server" Text="Supplier's ID"></asp:Label>
            </td>
