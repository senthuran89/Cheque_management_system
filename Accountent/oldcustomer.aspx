<%@ Page Language="C#" MasterPageFile="~/Accountent/Accountentmain.master" AutoEventWireup="true" CodeFile="oldcustomer.aspx.cs" Inherits="Accountent_oldcustomer" Title="Untitled Page" %>
        ...
        <tr>
            <td class="style17" valign="top">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:CMSConnectionString137 %>" 
                    SelectCommand="SELECT [Cid], [Firstname], [Lastname], [Address], [Companyname], [NICno], [Companyphone1], [Joindate], [Regno] FROM [Customer]">
                </asp:SqlDataSource>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="style18" bgcolor="Silver">
                ...
                <asp:SqlDataSource ID="SqlDataSource6" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:CMSConnectionString161 %>" 
                    SelectCommand="SELECT [Firstname] FROM [Customer]"></asp:SqlDataSource>
                <asp:SqlDataSource ID="SqlDataSource7" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:CMSConnectionString162 %>" 
        ...
        <tr>
            <td class="style18">
                ...
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:CMSConnectionString139 %>" 
                    SelectCommand="SELECT [Cid], [Firstname], [Lastname], [Address], [City], [NICno], [Companyname], [Companyaddress], [Companyphone1], [Joindate] FROM [Customer] WHERE ([Firstname] = @Firstname)">
                    <SelectParameters>
        ...
        <tr>
            <td class="style18">
                <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:CMSConnectionString141 %>" 
        ...
        <tr>
            <td class="style18">
                ...
                <asp:SqlDataSource ID="SqlDataSource4" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:CMSConnectionString143 %>" 
                    SelectCommand="SELECT [Cid], [Firstname], [Lastname], [City], [NICno], [Companyname], [Companyphone1], [Joindate] FROM [Customer] WHERE ([NICno] = @NICno)">
                    <SelectParameters>
        ...
        <tr>
            <td class="style18">
                ...
                <asp:SqlDataSource ID="SqlDataSource5" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:CMSConnectionString145 %>" 
                    SelectCommand="SELECT [Cid], [Firstname], [Lastname], [City], [NICno], [Companyname], [Companyaddress], [Companyphone1], [Joindate] FROM [Customer] WHERE ([Cid] = @Cid)">
                    <SelectParameters>
