<%@ Page Language="C#" MasterPageFile="~/CMSmain.master" AutoEventWireup="true" CodeFile="Adminlogin.aspx.cs" Inherits="Adminlogin" Title="Untitled Page" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <tr>
        ...
        <td bgcolor="Silver" class="style29">
            &nbsp;&nbsp;<asp:LinkButton ID="LinkButton1" runat="server" ForeColor="#990000" 
                onclick="LinkButton1_Click">LOGIN</asp:LinkButton>
        </td>
        <td class="style29">
            <asp:LinkButton ID="LinkButton2" runat="server" ForeColor="#990000" 
