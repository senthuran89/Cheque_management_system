<%@ Page Language="C#" MasterPageFile="~/cashier/Cashiermain.master" AutoEventWireup="true" CodeFile="Chequereturnview.aspx.cs" Inherits="cashier_Chequereturnview" Title="Untitled Page" %>
    ...
    <table bgcolor="#EFEFEF" frame="box" style="width: 97%;">
        ...
        <tr>
            <td class="style17" valign="top">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    CellPadding="4" DataKeyNames="Cid,ID" DataSourceID="SqlDataSource5" 
                ...
                <asp:SqlDataSource ID="SqlDataSource5" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:CMSConnectionString33 %>" 
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:CMSConnectionString32 %>" 
                    
                    SelectCommand="SELECT [Cid], [ID], [Firstname], [Companyname], [Companyphone1], [Personalphone], [bankname], [Bankcode], [Branchcode], [holdername], [Accountno], [Chequeno], [Getdate], [Chequetype], [Chequedate], [Amount], [Reson] FROM [cus_InchequeView] WHERE ([Chequestatus] = @Chequestatus)">
                    <SelectParameters>
                        <asp:Parameter DefaultValue="Deposit" Name="Chequestatus" Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>
        ...
        <tr>
            <td class="style19" bgcolor="#999999" valign="top">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button 
                    ID="Button9" runat="server" Text="Find" Width="96px" 
        ...
        <tr>
            <td class="style18">
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:CMSConnectionString29 %>" 
                    ...
                    <SelectParameters>
                        <asp:Parameter DefaultValue="Deposit" Name="Chequestatus" Type="String" />
                        <asp:SessionParameter Name="Chequeno" SessionField="ccheno" Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>
        ...
        <tr>
            <td class="style17" bgcolor="White">
                <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:CMSConnectionString30 %>" 
        ...
        <tr>
            <td class="style17" bgcolor="Gray">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button 
                    ID="Button11" runat="server" onclick="Button11_Click" Text="Find" 
                    Width="96px" />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
        </tr>
        <tr>
            <td class="style17" bgcolor="White">
                ...
                <asp:SqlDataSource ID="SqlDataSource4" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:CMSConnectionString31 %>" 
                    ...
                    <SelectParameters>
                        <asp:Parameter DefaultValue="Deposit" Name="Chequestatus" Type="String" />
                        <asp:SessionParameter Name="Chequeno" SessionField="ccheno1" Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>
            </td>
        </tr>
