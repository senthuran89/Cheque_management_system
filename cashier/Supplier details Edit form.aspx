<%@ Page Language="C#" MasterPageFile="~/cashier/Cashiermain.master" AutoEventWireup="true" CodeFile="Supplier details Edit form.aspx.cs" Inherits="cashier_Supplier_details_Edit_form" Title="Untitled Page" %>
        ...
        <table style="width:97%; height: 809px;" bgcolor="#EFEFEF" frame="box">
            <tr>
                <td bgcolor="#99CCFF" class="style62" colspan="4">
                    <asp:Label ID="Label3" runat="server" Font-Bold="True" 
                        Text="Supplier's Details Update Form."></asp:Label>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="style63" valign="top">
                    <asp:Label ID="Label31" runat="server" Text="Suppliers's ID"></asp:Label>
                </td>
            ...
            <tr>
                ...
                <td class="style64" valign="top">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                        ControlToValidate="TextBox17" ErrorMessage="Enter FirstName" 
                ...
                <td class="style19" valign="top">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                        ControlToValidate="TextBox18" ErrorMessage="Enter LastName" 
                        ValidationGroup="empty"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                ...
                <td class="style33" valign="top">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                        ControlToValidate="TextBox26" ErrorMessage="Seleact A City" 
                        ValidationGroup="empty"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="style43" valign="top" colspan="4">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:LinkButton 
                        ID="LinkButton5" runat="server" 
                        onclick="LinkButton5_Click" ValidationGroup="empty">Update Data</asp:LinkButton>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:LinkButton ID="LinkButton6" runat="server" onclick="LinkButton6_Click">View 
                    &amp; Edit Data</asp:LinkButton>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:LinkButton ID="LinkButton7" runat="server" onclick="LinkButton7_Click">Insert 
